    ...
    <div class="container my-5">
        ...
        <form method="get" class="mb-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    <input type="text" name="address" class="form-control" placeholder="Filter by address"
                        value="<?php echo htmlspecialchars($addressFilter); ?>">
                </div>
                <div class="col-md-3">
                    <input type="text" name="country" class="form-control" placeholder="Filter by country"
                        value="<?php echo htmlspecialchars($countryFilter); ?>">
                </div>
                <div class="col-md-3">
                    <input type="text" name="region" class="form-control" placeholder="Filter by region"
                        value="<?php echo htmlspecialchars($regionFilter); ?>">
                </div>
            </div>
                    ...
                    <div class="card shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="small text-muted">
                                ...
                                <?php echo htmlspecialchars($row["region"]); ?><br>
