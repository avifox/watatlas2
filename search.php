        ...
        <div class="row mt-4">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                    <img src="<?php echo $place['picture']; ?>" class="card-img-top"
                    ...
                    <div class="card-body">
                        ...
                        <a href="features/place.php?id=<?php echo $place['id']; ?>"
            ...
            <div class="text-center">
                <img src="uploads/basic/search-empty.jpg" alt="No results found" class="img-fluid"
